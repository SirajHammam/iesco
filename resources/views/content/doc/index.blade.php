...
<div class="container-fluid px-4">
    ...
    <button type="button" class="btn btn-success mb-3" data-bs-toggle="modal" data-bs-target="#exampleModal2">Create Blog</button>
    <div class="row">
      @foreach ($doc as $d)
        <div class="col-xl-6">
            <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    <a href="/show2/{{ $d->slug }}" class="d-flex justify-content-end text-decoration-none">Lihat Detail</a>
                  </div>
